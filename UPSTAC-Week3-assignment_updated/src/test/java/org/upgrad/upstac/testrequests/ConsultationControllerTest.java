...
class ConsultationControllerTest {
	...
	public void calling_assignForConsultation_with_valid_test_request_id_should_update_the_request_status() {
		...
		// Create another object of the TestRequest method and explicitly assign this
		// object for Consultation using assignForConsultation() method
	...
	public void calling_assignForConsultation_with_valid_test_request_id_should_throw_exception() {
		...
		// pass assignForConsultation() method
	...
	public void calling_updateConsultation_with_valid_test_request_id_should_update_the_request_status_and_update_consultation_details() {
		...
		// Create another object of the TestRequest method and explicitly update the
		// status of this object
		// to be 'COMPLETED'. Make use of updateConsultation() method from
		// labRequestController class (Pass the previously created two objects as
		// parameters)
	...
	public void calling_updateConsultation_with_invalid_test_request_id_should_throw_exception() {
		...
		// Create an object of ResponseStatusException . Use assertThrows() method and
		// pass updateConsultation() method
		// of consultationController with a negative long value as Id and the above
		// created object as second parameter
	...
	public void calling_updateConsultation_with_invalid_empty_status_should_throw_exception() {
		...
		// Create an object of ResponseStatusException . Use assertThrows() method and
		// pass updateConsultation() method
		// of consultationController with request Id of the testRequest object and the
	...
	public CreateConsultationRequest getCreateConsultationRequest(TestRequest testRequest) {
		...
		// if the lab result test status is Positive, set the doctor suggestion as
		// "HOME_QUARANTINE" and comments accordingly
		// else if the lab result status is Negative, set the doctor suggestion as
		// "NO_ISSUES" and comments as "Ok"
		// Return the object
		CreateConsultationRequest c = new CreateConsultationRequest();
		if (testRequest.getStatus().equals(TestStatus.NEGATIVE)) {
			c.setComments("OK");
			c.setSuggestion(DoctorSuggestion.NO_ISSUES);
		} else {
			c.setComments("Home quarantine");
			c.setSuggestion(DoctorSuggestion.HOME_QUARANTINE);
		}
